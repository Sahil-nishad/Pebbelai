      ...
      <section className="landing-hero">
        <div className="landing-content">
          ...
          <h1 className="landing-title">
            Build polished resumes with<br />clarity, speed, and confidence.
          </h1>
          <p className="landing-subtitle">
            Pabble AI combines a professional resume builder and an application tracker
            in one connected workflow, so building the resume and managing the job search
            feel like one system instead of two separate tools.
          </p>
          <div className="landing-cta-row">
            <button className="btn btn-black btn-xl" onClick={onOpenResumeFlow}>
              Open Resume Builder <ArrowRight size={18} />
            </button>
            <button className="btn btn-outline btn-xl" onClick={onOpenTrackerPreview}>
              <ClipboardList size={18} /> Open Tracker
            </button>
          </div>
    ...
    <div className="login-page">
      <div className="login-left">
        <div className="login-brand">
          <div className="navbar-logo-icon" style={{ width: 36, height: 36, fontSize: 18 }}>P</div>
          <span className="login-brand-text">Pabble AI</span>
        </div>
        <h1 className="login-headline">Welcome back.</h1>
        <p className="login-subtext">Sign in to access your resume workspace and templates.</p>
        <div className="login-features-list">
          <div className="login-feature"><Check size={16} /> 10 professional LaTeX templates</div>
          <div className="login-feature"><Check size={16} /> Guided content enhancement</div>
          <div className="login-feature"><Check size={16} /> ATS optimization scoring</div>
          <div className="login-feature"><Check size={16} /> PDF, .tex and tracking workspace</div>
        </div>
        <div className="login-testimonial">
          <div className="login-stars">
            <Star size={14} /><Star size={14} /><Star size={14} /><Star size={14} /><Star size={14} />
          </div>
          <p>&quot;Pabble AI helped me land 4 interviews in one week. The Jake Ryan template is perfect.&quot;</p>
          <span className="testimonial-author">— Alex D., Software Engineer</span>
        </div>
      </div>
      <div className="login-right">
        <div className="login-card">
          <h2>Sign In</h2>
          <p className="login-card-sub">Enter your workspace</p>
